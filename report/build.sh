...
$PANDOC report.tex -f latex -t html5 --standalone --embed-resources --mathml --resource-path=.:../figures --metadata title="Enrollment uncertainty and the proposed closure of Mesa Elementary" \
