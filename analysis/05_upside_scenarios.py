...
ax.plot([2013.6, 2019.4], [k_early, k_early], color=TEXT, lw=1.2); ax.text(2019.55, k_early, f"2014–19 average {k_early:.0f}", fontsize=6.8, ha="left", va="center")
ax.plot([2022.6, 2025.4], [k_recent, k_recent], color=TEXT, lw=1.2); ax.text(2025.6, k_recent + 1, f"2023–25\naverage {k_recent:.0f}", fontsize=6.8, ha="left", va="center")
ax.axhline(K_FILL, color=MUTED, lw=0.9, ls=":"); ax.text(2013.4, 121, f"dotted line: about {K_FILL:.0f} a year fills 492 seats at observed grade-to-grade gains", fontsize=6.5, color=MUTED, va="top", ha="left")
ax.set_xlabel("October of school year"); ax.set_ylabel("kindergarten students, both schools"); ax.legend(loc="upper right", fontsize=7); ax.set_ylim(0, 125); ax.set_xlim(2013.3, 2026.7)
