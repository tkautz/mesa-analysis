...
fig, (ax0, ax) = plt.subplots(1, 2, figsize=(10, 3.4), gridspec_kw=dict(width_ratios=[1.1, 1]))
...
ax0.set_xlabel("central estimate for merged 2030-31 enrollment, after seeing the Oct 2026 count"); ax0.set_ylabel("simulated Oct 2026 outcomes"); ax0.set_title(f"One count moves the answer: P10-P90 span {hi - lo:.0f} students (~{(hi - lo) / 25:.0f} classrooms)", fontsize=9.5)
...
ax.set_xticks(tab.decision_year); ax.set_xticklabels(["Sept 2026\n(counts through Oct 2025)", "Sept 2027\n(+ Oct 2026 count)", "Sept 2028\n(+ Oct 2027 count)"])
ax.set_ylabel("width of 80% interval for merged 2030-31 enrollment"); ax.set_title("Expected narrowing of the 2030-31 band from waiting (90% of Mesa follow)")
